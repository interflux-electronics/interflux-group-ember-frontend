...
export default class HeadDataService extends Service {
  @tracked title = 'Interflux Group';

  // prettier-ignore
  @tracked description = 'The Interflux Group is an international network of companies supplying the electronics manufacturing industry with equipment, soldering chemistry and know-how.';
  ...
  get canonicalURL() {
    return `https://interflux.group/${this.canonicalPath}`;
  }
